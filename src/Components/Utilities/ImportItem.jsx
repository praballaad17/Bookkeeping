...
// import sample from "/sample1.xlsx";
...
export default function ImportItem() {
  ...
  if (excelData) return <ItemTable excelData={excelData} />;
      ...
      <div className="importitem">
        ...
        <div className="importitem__block">
          <div className="importitem--left">
            ...
            <a href="/sample1.xlsx" className="btn btn--primary">
              Download Sample
            </a>
            <img
              src="https://exceltable.com/en/analyses-reports/images/analyses-reports29-1.png"
              alt="sample photo"
            />
            <h4>STEP 2</h4>
            <span>
              <i className="fa fa-upload" aria-hidden="true"></i>Upload the file
              (xlsx or xls) by clicking on the Upload File button below.
            </span>
            <h4>STEP 3</h4>
